...
def define_train_parameters(args, descriptions_file):
    # TRAIN dataset
    ...
    return train, train_descriptions, train_rnn_input, bboxes
    
    
def define_dev_parameters(args, descriptions_file, bboxes):
    # DEV dataset
    # load val/dev set
    ...
    return val, val_descriptions, val_rnn_input
    

def fit_model(train, train_descriptions, train_rnn_input, val, val_descriptions, val_rnn_input):
    # prepare tokenizer
...
def main(args):
    # descriptions
    descriptions_file = args[1] if len(args) > 1 else 'descriptions.txt'
    #prepare train parameters
    train, train_descriptions, train_rnn_input, flag = define_train_parameters(args, descriptions_file)
    #prepare dev parameters
    val, val_descriptions, val_rnn_input = define_dev_parameters(args, descriptions_file, flag)
    # fit model
